...
POST, PRI, PROPFIND, PROPPATCH, PURGE, PUT, QUERY, REBIND, REPORT,
RPC_IN_DATA, RPC_OUT_DATA, SEARCH, SUBSCRIBE, TRACE, TRACK, UNBIND,
UNCHECKOUT, UNLINK, UNLOCK, UNSUBSCRIBE, UPDATE, UPDATEREDIRECTREF,
VERSION-CONTROL, X-MS-ENUMATTS
```
